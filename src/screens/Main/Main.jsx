...
import vector from '../../images/vectorblue2.jpg'
			...
			<Grid style = {styles.Material} container justifyContent="center" alignItems='center' >
				...
				<Grid style={styles.Margin} item sm={6} xs={12} md={3}>
					<Paper style={styles.materialItem} elevation={3} >
						<img style={styles.cardImage} src={vector} alt={vector} />

						<Grid item>
						    <p style={styles.cardHeading} > Reacts </p>
						    <p style={styles.cardDescription} > React on Nodejs </p>
